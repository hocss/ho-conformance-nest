...
export default class Nest extends Base {
    ...
    onRuleset( rule ) {
        ...
        if ( children.length > 0 ) {
            ...
            this.log( chalk.cyan( this.tree.pwd ), chalk.magenta( this.tree.current.level ) )
            return
        }

        var current = this.tree.current
        ...
        this.log( chalk.cyan( this.tree.pwd, this._parseSelectors( rule.raw.selectors ) ), chalk.magenta( current.level ) )
    }
